...
void words::gamePlay()
{
	...
	string guess = "AAAAAAAAAAA";
	int ctr = 0;
	//-----------
	if (wordPos == "right")
	{

		while (colNum1 != colNum2+1)
		{
			guess[ctr] = letters[rowNum1][colNum1];
			//cout << " Just assigned '" << letters[rowNum1][colNum1] << "' to guess\n";
			ctr++;
			colNum1++;
			
		}
	}
	else if (wordPos == "left")
	{
	...
	else if (wordPos == "down")
	{

		while (rowNum1 != rowNum2 + 1)
		{
			guess[ctr] = letters[rowNum1][colNum1];
			//cout << " Just assigned '" << letters[rowNum1][colNum1] << "' to guess\n";
			ctr++;
